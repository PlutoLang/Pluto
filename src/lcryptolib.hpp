...
uint32_t crc32_impl ( const void * key, int len, uint32_t seed)
{
...
https://github.com/983/SHA-256/blob/main/LICENSE
*/
...
/*
------------------------------------------------------------------------------
 Call rand_isaac() to retrieve a single 64-bit random value
------------------------------------------------------------------------------
*/
#define rand_isaac() \
