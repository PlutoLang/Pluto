...
local function lexerror (s, err)
  ...
  -- [Pluto] only checking for failure because our error messages look very different
  assert(not st)
end
...
-- [Pluto] we remove this restriction
--[[for i = 0, 255 do
...
local function malformednum (n, exp)
  ...
  -- [Pluto] again, only checking failure due to error message differences
  assert(not s)
end
