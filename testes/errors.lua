...
-- [Pluto] error message difference again...
--checksyntax([[
--  local a = {4
--
...
--checkmessage([[x = "a" .. false]], "concatenate") -- [Pluto] this is allowed
...
a, b, c = xpcall(string.find, function (x) return {} end, nil, "al") -- [Pluto] using nil instead of bool
...
-- local variables
-- [Pluto] we have different limits here
--[[s = "\nfunction foo ()\n  local "
for j = 1,300 do
  s = s.."a"..j..", "
end
